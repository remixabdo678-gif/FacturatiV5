...
import { useStock } from './StockContext'; // ✅ on utilise directement le hook
...
export function DataProvider({ children }: { children: ReactNode }) {
  ...
  // 👉 ici tu gardes tout ton code de gestion (addClient, updateClient, addProduct, addInvoice, etc.)
  // Rien n'a changé à part la ligne du stockContext
